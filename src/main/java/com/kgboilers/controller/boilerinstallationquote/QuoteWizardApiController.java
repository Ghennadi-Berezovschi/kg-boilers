...
public class QuoteWizardApiController {
    ...
    @PostMapping("/flue-shape")
    public ResponseEntity<QuoteResponseDto> setFlueShape(@RequestBody @Valid HorizontalFlueShapeRequestDto request,
                                                         HttpSession session) {
        ...
        QuoteStep nextStep = wizardService.updateHorizontalFlueShape(state, request.getFlueShape());
